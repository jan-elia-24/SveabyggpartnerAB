      ...
      <div className="px-10 md:px-16 pt-16 pb-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex flex-col items-start md:items-center gap-1.5">
            <p className="font-sans text-muted text-xs">
              Utvecklad av <span className="text-foreground">Jan Elia</span>
            </p>
            <div className="flex items-center gap-3">
              <a href="https://github.com/jan-elia-24" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-rust transition-colors" aria-label="GitHub">
              ...
              <a href="https://portfolio1-lemon-tau.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-rust transition-colors" aria-label="Portfolio">
              ...
              <a href="https://www.linkedin.com/in/jan-elia/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-rust transition-colors" aria-label="LinkedIn">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
